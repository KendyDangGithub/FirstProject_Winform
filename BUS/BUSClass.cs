...
namespace BUS
{
    public class BUSClass
    {
        ...
        public string InsertClass(string malop, string tenlop, string machuyennganh)
        {
            ...
            else
            {
                ...
                {
                    if(DALClass.Instance.InsertClass(malop, tenlop, machuyennganh) > 0)
                    {
                        return "";
                    }
                    else
        ...
        public string UpdateClass(string malop, string tenlop, string machuyennganh)
        {
            if (DALClass.Instance.GetClassByID(malop).Rows.Count ==0 )
            {
            ...
            else
            {
                ...
                {
                    if (DALClass.Instance.UpdateClass(malop, tenlop, machuyennganh) != 0)
                    {
                        return "";
                    }
                    else
