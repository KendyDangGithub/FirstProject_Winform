...
namespace BUS
{
    public class BUSSubject
    {
        ...
        public string InsertSubject(string mahp, string tenhp, int sotc)
        {
            ...
            else
            {
                ...
                {
                    if (DALSubject.Instance.InsertSubject(mahp, tenhp, sotc) > 0)
                    {
                        return "";
                    }
                    else
        ...
        public string UpdateSubject(string mahp, string tenhp, int sotc)
        {
            if (DALSubject.Instance.GetSubjectByID(mahp).Rows.Count == 0)
            {
            ...
            else
            {
                ...
                {
                    if (DALSubject.Instance.UpdateSubject(mahp, tenhp, sotc) != 0)
                    {
                        return "";
                    }
                    else
