...
namespace DAL
{
    public class DALLecturer
    {
        ...
        public int InsertGiangVien(string magv,
                             ...
                             string makhoa)
        {
            string query = "USP_INSERT_GIANGVIEN @MAGV , @HOTEN , @GIOITINH , @NGAYSINH , @DIACHI , @SOCCCD , @SODIENTHOAI , @MAKHOA";
            return DataProvider.Instance.ExecuteNonQuery(query, new object[] { magv, hoten, gioitinh, ngaysinh, diachi, socccd, sdt, makhoa });
        }
        ...
        public int UpdateGiangVien(
                                 ...
                                 string makhoa)
        {
            string query = "USP_UPDATE_GIANGVIEN @MAGV , @HOTEN , @GIOITINH , @NGAYSINH , @DIACHI , @SOCCCD , @SODIENTHOAI , @MAKHOA";
            return DataProvider.Instance.ExecuteNonQuery(query, new object[] { magv, hoten, gioitinh, ngaysinh, diachi, socccd, sdt, makhoa });
        }
